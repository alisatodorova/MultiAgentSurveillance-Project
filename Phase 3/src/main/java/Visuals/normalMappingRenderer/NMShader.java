...
public class NMShader extends ShaderProgram3D{
	...
	private static final String VERTEX_FILE = "src/main/java/Visuals/normalMappingRenderer/NMVertexShader.txt";
	private static final String FRAGMENT_FILE = "src/main/java/Visuals/normalMappingRenderer/NMFragmentShader.txt";
